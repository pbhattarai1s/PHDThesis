...
\begin{table}[!htbp]
    ...
    \hline 
    QCD MC modelling & 1.97 & 0.16 & \textbf{7.12}\\
    Jet & \textbf{7.26} & \textbf{6.75} & \textbf{6.16}\\
    Trigger & 0.03 & 0.06 & 0.08 \\
    Leptons & 1.42 & 1.49 & 1.56 \\
    PRW & 0.39 & 0.06 & 0.16\\
    Theory ($qqZZ$) & 1.93 & 2.29 & 2.07 \\
    Theory (EWK $qqZZjj$) & 0.02 & 0.02 & 0.04 \\
    Theory ($ggZZ$) & 0.13 & 0.22 & 0.28 \\
    MC Bkg. (ttV+VVV) & 1.61 & 1.72 & 1.52 \\
    Fake Bkg. (stat + syst) & 3.43 & 2.95 & 2.62 \\ 
    Luminosity & 1.48 & 1.36 & 1.45 \\
    Unfolding Bias & \textbf{11.76} & \textbf{10.95} & \textbf{6.06}\\
    \hline
    Total & 14.74 & 13.64 & 11.98 \\
    \hline
    \end{tabular}
\end{table}

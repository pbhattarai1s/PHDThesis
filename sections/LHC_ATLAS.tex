...
\begin{figure}
    ...
    \caption{ A schematic of electromagnetic and hadronic calorimeters for ATLAS \cite{ATLAS}.\label{fig:ATLAS_Cals}}
\end{figure}
...
\begin{figure}
    ...
    \caption{ A schematic of muon spectrometer for ATLAS \cite{ATLAS}.\label{fig:ATLAS_MS}}
\end{figure}